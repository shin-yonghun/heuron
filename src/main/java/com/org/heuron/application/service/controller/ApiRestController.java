...
public class ApiRestController {
    ...
    @GetMapping(value = "/patient_img/{psn}")
    @Operation(summary = "환자 이미지 조회 API", description = "환자 이미지를 조회한다.")
    public ResponseEntity<Resource> getPatientImg(@Schema(description = "환자고유번호") @PathVariable(name = "psn") Long param) {
    ...
    public ResponseBase deletePatient(@Valid @RequestBody PatientRequest param) {
